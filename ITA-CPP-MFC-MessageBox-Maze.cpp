...
// ITA-CPP-MFC-MessageBox-Maze.cpp: Definiert das Klassenverhalten für die Anwendung.
//
...
BEGIN_MESSAGE_MAP(CITACPPMFCMessageBoxMazeApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CITACPPMFCMessageBoxMazeApp-Erstellung

CITACPPMFCMessageBoxMazeApp::CITACPPMFCMessageBoxMazeApp()
{
...
// Das einzige CITACPPMFCMessageBoxMazeApp-Objekt

CITACPPMFCMessageBoxMazeApp theApp;


// CITACPPMFCMessageBoxMazeApp-Initialisierung

BOOL CITACPPMFCMessageBoxMazeApp::InitInstance()
{
	...
	CITACPPMFCMessageBoxMazeDlg dlg;
	m_pMainWnd = &dlg;
